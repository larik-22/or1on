...
(async () => {
    ...
    const user6 = await em.getRepository(User).findOne({username: 'dummyUser6'});
    const user8 = await em.getRepository(User).findOne({username: 'dummyUser8'});
    const user9 = await em.getRepository(User).findOne({username: 'dummyUser9'});
    const user11 = await em.getRepository(User).findOne({username: 'dummyUser11'});
